...
public class Checkout_LoggedUser {
	...
	By ShopElement2 = By.cssSelector("a[href='http://itluma.com/product/blazzer/']");
	...
	public void LoggedUser()
	{
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(ShopElement2));
				
		driver.findElement(By.cssSelector("a[href='?add-to-cart=5212']")).click();
				
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		WebElement element2 = driver.findElement(By.cssSelector("a[href='http://itluma.com/checkout/']"));
